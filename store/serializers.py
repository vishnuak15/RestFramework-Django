...
class ProductSerializer(serializers.ModelSerializer):
    ...
    description = serializers.CharField(min_length=4,max_length=200)
    ...
    class Meta:
        model = Product
        fields = ('id', 'name', 'description', 'price', 'sale_start', 'sale_end','is_on_sale','current_price','description','cart_items')
